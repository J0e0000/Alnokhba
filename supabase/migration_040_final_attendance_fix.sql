-- ============================================================================
-- Migration 040 — الإصلاح النهائي للحضور (تسجيل عدة حصص في نفس اليوم)
-- اسم الملف: migration_040_final_attendance_fix.sql
-- ============================================================================
-- المشكلة المؤكدة على قاعدة البيانات الحقيقية (فحص 100 طالب / 105 سجل):
