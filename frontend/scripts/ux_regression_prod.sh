...
set -u
cd /home/z/my-project/.prod-deploy/frontend
mkdir -p /home/z/my-project/download/ux-test-prod
...
$B screenshot /home/z/my-project/download/ux-test-prod/01-home-desktop.png
...
sleep 3
$B screenshot /home/z/my-project/download/ux-test-prod/02-session-attendance-focus.png
...
sleep 1.2
$B screenshot /home/z/my-project/download/ux-test-prod/03-after-present-mark.png
...
sleep 1.2
$B screenshot /home/z/my-project/download/ux-test-prod/04-student2-absent.png
...
sleep 0.8
$B screenshot /home/z/my-project/download/ux-test-prod/05-attendance-list.png
...
sleep 1.2
$B screenshot /home/z/my-project/download/ux-test-prod/06-interaction.png
...
sleep 1.2
$B screenshot /home/z/my-project/download/ux-test-prod/07-review.png
...
sleep 1.2
$B screenshot /home/z/my-project/download/ux-test-prod/08-report.png
$B eval "(() => { const bar = document.querySelector('.nk-workflow-bar'); return JSON.stringify({ heading: document.querySelector('[role=tabpanel] h3').innerText, primary: Array.from(bar.querySelectorAll('.nk-workflow-bar__primary button')).map(b => b.innerText) }) })()"
...
sleep 1
$B screenshot /home/z/my-project/download/ux-test-prod/09-finish-confirm.png
...
sleep 3
$B screenshot /home/z/my-project/download/ux-test-prod/10-after-finish.png
...
sleep 0.8
$B screenshot /home/z/my-project/download/ux-test-prod/11-account-menu.png
...
$B screenshot /home/z/my-project/download/ux-test-prod/12-logout-confirm.png
...
sleep 1.5
$B screenshot /home/z/my-project/download/ux-test-prod/13-home-mobile.png
...
sleep 2.5
$B screenshot /home/z/my-project/download/ux-test-prod/14-attendance-mobile.png
...
$B screenshot /home/z/my-project/download/ux-test-prod/15-attendance-mobile-scrolled.png --full 2>/dev/null || true
